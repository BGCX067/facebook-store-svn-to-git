...
class Stores_Form_Store extends HTS_Form
{
    /**
    ...
    public function init()
	{
        ...
        $this->addElement('text', 'name', array(
            'label' => "LABEL_STORE_NAME",
            'required' => true,
            'validators' => array(
                $this->_getValidatorNotEmpty('LABEL_STORE_NAME'),
                $this->_getValidatorStringLength(10, 255, 'UTF-8', 'LABEL_STORE_NAME')
            ),
        ...
        $this->addElement('file', 'banner', array(
            ...
            'decorators' => $this->_customDecorators('File'),
